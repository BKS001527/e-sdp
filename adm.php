								...
								<nav class="cl-effect-1">
									<ul class="nav navbar-nav ">
										...
										<li><a href="ment.php">Mentee</a></li>
                                                                                <li><a href="men.php"><font color="orange">Administrator</font></a></li>
...
<!-- Form Name -->
<h2><legend><font color="voilet">Administrator Login</font></legend></h2>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="suser">Username</label>  
  <div class="col-md-4">
  <input id="muser" name="suser" type="text" placeholder="VTUXXXX" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="mpass" name="spass" type="password" placeholder="password" class="form-control input-md" required="">
